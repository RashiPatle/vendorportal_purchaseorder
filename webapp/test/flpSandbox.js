		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor Portal - Purchase Order",
									"targetURL": "#comiherbtmztmvpsiherb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiherbtmztmvpsiherb-display": {
								"semanticObject": "comiherbtmztmvpsiherb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iherb.tm.ztmvpsiherb",
									"url": sap.ui.require.toUrl("com/iherb/tm/ztmvpsiherb")
								}
							}
						}
					}
